...
CORE_FILE_FOR_JVM_1C = {
    "tomcat": "benchmark_profiling/csv/tomcat_core.csv",
    "finagle-http": "benchmark_profiling/csv/finagle_http_core.csv",
    "finagle-chirper": "benchmark_profiling/csv/finagle_chirper_core.csv",
}

NON_JVM = {
    "verilator-qsort": "benchmark_profiling/csv/verilator_qsort_core.csv",
    "602.gcc_s": "benchmark_profiling/csv/spec602_core.csv",
    "605.mcf_s": "benchmark_profiling/csv/spec605_core.csv",
    "641.leela_s": "benchmark_profiling/csv/spec641_core.csv",
}
...
def main():
    ...
    ctx_csv = Path(args.ctx_csv) if args.ctx_csv else (results / "jvm_context_switch/csv/contextswitch_core0_mpki.csv")
    ctx4_csv = Path(args.ctx4_csv) if args.ctx4_csv else (results / "jvm_context_switch/csv/contextswitch_core0_frontend4_jvm.csv")
