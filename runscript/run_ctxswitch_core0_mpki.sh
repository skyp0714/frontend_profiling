...
MAIN_CSV="${MAIN_CSV:-${PROFILING_DIR}/results/main_frontend_all.csv}"
LEGACY_CSV="${LEGACY_CSV:-${PROFILING_DIR}/results/contextswitch_core0_mpki.csv}"
OUT_PNG="${OUT_PNG:-${PROFILING_DIR}/results/contextswitch_core0_mpki.png}"
...
"${PYTHON_BIN}" "${SCRIPT_DIR}/plot_ctxswitch_core0_mpki.py" \
  --input "${INPUT_CSV}" \
